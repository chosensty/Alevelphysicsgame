...
class Game:
    ...
    def initialise_e_sim(self):
        ...
        self.ui.add_object(Button(200, 25, "Add Resistor", self.electricity.select_resistor, "RESISTOR"))
        self.ui.add_object(Button(200, 25, "Add Cell", self.electricity.select_cell, "CELL"))
        self.ui.add_object(Button(200, 25, "Rotate", self.electricity.change_orientation, "ROTATE"))
        self.ui.add_object(Button(200, 25, "GENERATE", self.electricity.generate_netlist, "GENERATE", "#00ff00"))
